...
export const COURSE_CONFIGS = {
  ...
  'cbse-9': {
    courseId: 'cbse-9',
    courseName: 'CBSE Class 9',
    examContext: 'CBSE Class 9',
    examKey: 'GENERIC',
    examLabel: 'CBSE Class 9',
    targetAudience: 'Class 9 Students',
    questionStyle: 'Board-aligned foundational conceptual questions with NCERT focus',
    contentRules: {
      emphasizeBoardPatterns: true,
      preferConceptualQuestions: true,
      keepDifficultyModerate: true,
  ...
  'cbse-10': {
    courseId: 'cbse-10',
    courseName: 'CBSE Class 10',
    examContext: 'CBSE Class 10',
    examKey: 'GENERIC',
    examLabel: 'CBSE Class 10',
