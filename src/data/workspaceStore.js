...
function getSeedWorkspaces() {
  return [
    ...
    },
    {
      ...
      icon: 'chapters',
      themeColor: '#0E9494',
      description: 'Central Board of Secondary Education Class 9 - Science & Mathematics',
      status: 'active',
      published: true,
      version: 'v1.0',
      ...
      practice: [],
      mockTests: [],
      analytics: { totalAttempts: 35, avgAccuracy: 70, weeklyProgress: 15, trend: [50, 58, 65, 70] },
      studentProgress: { enrolled: 3, active: 3, completionRate: 60 },
      bookmarks: [],
      downloads: [],
      aiStudyPlan: { generated: true, plan: { focus: 'Science', dailyTarget: 60 } },
      contentHealth: { score: 90, issues: [], lastChecked: '2026-08-20' },
      settings: { allowDownloads: true, allowBookmarks: true, showLeaderboard: false, requireEnrollment: false },
      theme: { primaryColor: '#0E9494', darkMode: true },
      metadata: { subjects: 2, chapters: 5, mcqs: 95, flashcards: 59, notes: 8, completion: 60, health: 90 },
      audit: { createdBy: 'admin', lastModifiedBy: 'admin', revision: 2 },
    },
    {
      id: 'cbse-10',
      name: 'CBSE Class 10',
      icon: 'computer',
      themeColor: '#2E5CE6',
      description: 'Central Board of Secondary Education Class 10 - Science & Mathematics',
      status: 'active',
      published: true,
      version: 'v1.0',
      createdAt: '2026-08-01',
      ...
      practice: [],
      mockTests: [],
      analytics: { totalAttempts: 45, avgAccuracy: 75, weeklyProgress: 20, trend: [55, 62, 70, 75] },
      studentProgress: { enrolled: 1, active: 1, completionRate: 65 },
      bookmarks: [],
      downloads: [],
      aiStudyPlan: { generated: true, plan: { focus: 'Physics', dailyTarget: 70 } },
      contentHealth: { score: 92, issues: [], lastChecked: '2026-08-20' },
      settings: { allowDownloads: true, allowBookmarks: true, showLeaderboard: false, requireEnrollment: false },
      theme: { primaryColor: '#2E5CE6', darkMode: true },
      metadata: { subjects: 2, chapters: 3, mcqs: 53, flashcards: 34, notes: 5, completion: 65, health: 92 },
      audit: { createdBy: 'admin', lastModifiedBy: 'admin', revision: 2 },
    },
  ]
}
