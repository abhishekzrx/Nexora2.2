 ...
 * Canonical Chapter Specification for "BPSC PRE LIMS" (57 chapters across 8 subjects)
...
export const BPSC_PRELIMS_CHAPTERS = [
  ...
  // ----------------------------------------------------
  {
    ...
    subjectPrefix: 'HIST',
    title: 'Ancient India: Prehistoric Era to Guptas',
    aliases: ['ancient india: prehistoric era to guptas', 'ancient india', 'prehistoric era to guptas'],
    description: 'Covers Chalcolithic and Indus Valley sites (Harappa, Chirand), Vedic literature, the rise of Mahajanapadas, Mauryan administration and Ashokan edicts, Gupta art/literature, and Harshavardhana\'s reign. Questions must test royal titles, administrative terms, and ancient texts.',
    priority: 'H',
    priorityLabel: 'High',
  },
  {
    ...
    subject: 'Indian History',
    subjectPrefix: 'HIST',
    title: 'Heterodox Religious Movements (Buddhism & Jainism)',
    aliases: ['heterodox religious movements (buddhism & jainism)', 'heterodox religious movements', 'buddhism and jainism'],
    description: 'Focuses on the socio-religious causes behind the rise of Buddhism and Jainism, life and teachings of Mahavira and Buddha, Buddhist Councils (venues, presidents, patrons), Jain Tirthankaras, philosophy, and monastic orders.',
    priority: 'VH',
    priorityLabel: 'Very High',
  },
  {
    ...
    subject: 'Indian History',
    subjectPrefix: 'HIST',
    title: 'Medieval Dynasties & Cultural History',
    aliases: ['medieval dynasties & cultural history', 'medieval india', 'delhi sultanate and mughals'],
    description: 'Encompasses the Delhi Sultanate (administrative reforms of Iltutmish, Alauddin Khilji, Muhammad bin Tughlaq), Mughal Empire (Mansabdari system, revenue architecture of Todar Mal, religious policies), Vijayanagara kingdom, Marathas, and Bhakti/Sufi saints. Items should target land tenure terminology, foreign travelers, and court literature.',
    priority: 'M',
    priorityLabel: 'Medium',
  },
  {
    ...
    aliases: ['advent of europeans & british expansion', 'advent of europeans', 'british expansion'],
    description: 'Covers early European trade settlements (Portuguese, Dutch, French, British), Carnatic Wars, Battles of Plassey and Buxar, Subsidiary Alliance, and Doctrine of Lapse. MCQs should focus on treaties, charters, and early colonial administrative setups.',
    priority: 'H',
    priorityLabel: 'High',
  },
  {
    ...
    subject: 'Indian History',
    subjectPrefix: 'HIST',
    title: 'Socio-Religious Reform Movements & Tribal/Peasant Uprisings',
    aliases: ['socio-religious reform movements & tribal/peasant uprisings', 'socio-religious reform movements', 'tribal and peasant uprisings'],
    description: 'Focuses on Brahmo Samaj, Arya Samaj, Ramakrishna Mission, Theosophical Society, Aligarh Movement, Wahabi Movement in Bihar, Santhal Rebellion (1855), Munda Ulgulan (Birsa Munda), Indigo Revolt, Pabna Movement, and Deccan Riots. Items must test founders, publications, locations, and chronological sequence.',
    priority: 'VH',
    priorityLabel: 'Very High',
  },
  {
    ...
    aliases: ['the revolt of 1857', 'revolt of 1857', '1857 uprising'],
    description: 'Examines political, economic, military, and immediate causes of the 1857 uprising, key regional leadership centers, reasons for failure, administrative restructuring under the Government of India Act 1858, and Queen’s Proclamation.',
    priority: 'VH',
    priorityLabel: 'Very High',
  },
  {
    ...
    subject: 'Indian History',
    subjectPrefix: 'HIST',
    title: 'Indian National Congress & Moderate-Extremist Phase',
    aliases: ['indian national congress & moderate-extremist phase', 'indian national congress', 'moderate extremist phase'],
    description: 'Focuses on the foundation of the INC (1885), early leadership, Moderate strategies, Partition of Bengal (1905), Swadeshi Movement, Surat Split (1907), Morley-Minto Reforms (1909), and the Lucknow Pact (1916).',
    priority: 'H',
    priorityLabel: 'High',
  },
  {
    ...
    subject: 'Indian History',
    subjectPrefix: 'HIST',
    title: 'Gandhian Era & Freedom Movements (1917–1947)',
    aliases: [
      'gandhian era & freedom movements (1917–1947)',
      'gandhian era & freedom movements',
      'gandhi era & gandhian national movement (1915–1947)',
      'gandhian era',
      'freedom struggle',
    ],
    description: 'Encompasses Rowlatt Act, Jallianwala Bagh, Non-Cooperation Movement, Swaraj Party, Simon Commission, Nehru Report, Civil Disobedience Movement, Round Table Conferences, Gandhi-Irwin Pact, Poona Pact, Government of India Act 1935, Quit India Movement, Cabinet Mission, and Mountbatten Plan culminating in Indian Independence.',
    priority: 'VH',
    priorityLabel: 'Very High',
  },
...
export function getBpscChapterMeta(name, code) {
  ...
  return (
    BPSC_PRELIMS_CHAPTERS.find(
      (c) =>
        c.title.toLowerCase().trim() === norm ||
        c.code.toLowerCase().trim() === norm ||
        (c.aliases && c.aliases.some((a) => a.toLowerCase().trim() === norm || norm.includes(a.toLowerCase().trim())))
    ) || null
  )
}
 ...
 * Reconciles/seeds all 57 BPSC PRE LIMS chapters in Supabase.
