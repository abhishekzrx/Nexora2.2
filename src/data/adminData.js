...
export const adminSubjects = [
  {
    ...
    desc: 'Comprehensive guide to network protocols, architectures and systems',
    stats: [
  ...
  },
  {
    ...
    name: 'Physics',
    icon: 'physics',
    desc: 'Classical mechanics, thermodynamics, waves and modern physics',
    stats: [
      { value: '12', label: 'Chapters' },
      { value: '280', label: 'MCQs' },
      { value: '220', label: 'Flashcards' },
      { value: 'Active', label: 'Status' },
    ],
  },
  {
    ...
    name: 'Chemistry',
    icon: 'chemistry',
    desc: 'Organic, inorganic chemistry, chemical reactions and bonding',
    stats: [
      { value: '14', label: 'Chapters' },
      { value: '320', label: 'MCQs' },
      { value: '250', label: 'Flashcards' },
      { value: 'Active', label: 'Status' },
    ],
  },
  {
    ...
    name: 'Biology',
    icon: 'biology',
    desc: 'Cell biology, genetics, ecology, human physiology and systems',
    stats: [
      { value: '16', label: 'Chapters' },
      { value: '340', label: 'MCQs' },
      { value: '280', label: 'Flashcards' },
      { value: 'Active', label: 'Status' },
    ],
  },
]
